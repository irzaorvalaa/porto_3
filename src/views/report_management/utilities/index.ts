...
export const getReport = async (signal: AbortSignal, filter?: IReportFilter) => {
  return await httpService.get<IReportResponse>({
...
export const exportExcel = async (signal: AbortSignal, filter?: IReportFilter) => {
