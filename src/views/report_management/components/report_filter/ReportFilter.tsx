...
import { IReportFilter, IReportFilterProps } from './interfaces'
import { allCampusOptions, allTopicOptions, initialStateReportFilter } from './constants'
...
const ReportFilter = ({
  ...
  // State
  const [filter, setFilter] = React.useState<IReportFilter>(initialStateReportFilter)
  ...
  const setValue = (field: keyof IReportFilter, value: string) => {
