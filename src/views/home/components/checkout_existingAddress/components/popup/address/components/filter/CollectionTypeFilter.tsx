...
import { IAddressFilter, IAddressFilterProps } from './interfaces'
import { allOption, initialStateAddressFilter } from './constants'
import './CollectionTypeFilter.scss'
import { IFormDataOption } from '../../../../../../../../../interfaces/IFormData'

const CollectionTypeFilter = ({ loading = false, onShow }: IAddressFilterProps) => {
  // State
  const [filter, setFilter] = React.useState<IAddressFilter>({
    ...initialStateAddressFilter,
  })
  ...
  const setValue = (field: keyof IAddressFilter, value: string) => {
