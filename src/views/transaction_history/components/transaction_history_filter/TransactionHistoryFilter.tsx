...
import { IReferenceServiceReportFilter, IReferenceServiceReportFilterProps } from './interfaces'
import {
  allCampusOptions,
  allTopicOptions,
  initialStateReferenceServiceReportFilter,
} from './constants'
import { FORMAT_DATE_INPUT, FORMAT_DATE_POST } from '../../../../constants/Parameter'
import { IGeneralFetch } from '../../../../interfaces/IGeneralFetch'
import './TransactionHistoryFilter.scss'
...
const TransactionHistoryFilter = ({
  ...
  onExport,
  onCampusChange,
}: IReferenceServiceReportFilterProps) => {
  const startOfMonth = moment().startOf('month').toDate()
  const endOfMonth = moment().endOf('month').toDate()

  // State
  const [filter, setFilter] = React.useState<IReferenceServiceReportFilter>(
    initialStateReferenceServiceReportFilter,
  )
  ...
  const setValue = (field: keyof IReferenceServiceReportFilter, value: string) => {
