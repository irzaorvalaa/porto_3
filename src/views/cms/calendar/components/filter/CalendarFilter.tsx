...
import { ICalendarFilter, ICalendarFilterProps } from './interfaces'
import { allOption, initialStateCalendarFilter } from './constants'
...
const CalendarFilter = ({
  ...
  // State
  const [filter, setFilter] = React.useState<ICalendarFilter>({
    ...initialStateCalendarFilter,
  })
  ...
  const setValue = (field: keyof ICalendarFilter, value: string) => {
